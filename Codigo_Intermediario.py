        ...
        for token in self.lista_tokens:
            ...
            if token[0] == 'ler' :
               ...
               self.log_intermediario.write(f'Comando de leitura da variavel {self.lista_tokens[i+2][1]} \n') 
                ...
                self.cod_intermediario.append("repita")
                self.log_intermediario.write("Comando de repeticao `do` reconhecido\n ") 
                ...
                self.cod_intermediario.append(f'enquanto {condicao}')
                ...
                self.log_intermediario.write("Comando fim de condicional `endif` reconhecido\n ") 
