    ...
    def inicia_geracao(self):
        ...
        for line in  self.codigo_intermediario:
            if line.split()[0] == 'leia':
                ...
                self.codigo_final.append("BL printf      @call function for print")
            ...
            elif line.split()[0] == "repita": 
                self.log_final.write("Comando `do` executado\n")
                ...
                self.codigo_final.append("{0}:      @label for `do`".format(label_do))
                self.codigo_final.append("{0}:      @label content `do`".format(self.label_if))
                ...
                self.calc_expLogic(exp, 'enquanto')

                self.codigo_final.append("{0}:      @label for endDo-while".format(self.stack_label.pop()))
